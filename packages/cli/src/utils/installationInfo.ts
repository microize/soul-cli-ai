...
export function getInstallationInfo(
  ...
  try {
    ...
    if (realPath.includes('/.pnpm/global')) {
      const updateCommand = 'pnpm add -g @nightskyai/soul-cli-ai@latest';
      return {
    ...
    if (realPath.includes('/.yarn/global')) {
      const updateCommand = 'yarn global add @nightskyai/soul-cli-ai@latest';
      return {
    ...
    if (realPath.includes('/.bun/bin')) {
      const updateCommand = 'bun add -g @nightskyai/soul-cli-ai@latest';
      return {
    ...
    // Assume global npm
    const updateCommand = 'npm install -g @nightskyai/soul-cli-ai@latest';
    return {
